...
#include <memory>
#include "../../../../../../src/businesslogic/sensor.h"
...
Q_CONSTINIT static const qt_meta_stringdata_sensor_t qt_meta_stringdata_sensor = {
    {
        ...
        QT_MOC_LITERAL(7, 12),  // "valueChanged"
        QT_MOC_LITERAL(20, 0),  // ""
        QT_MOC_LITERAL(21, 8),  // "newValue"
        QT_MOC_LITERAL(30, 14),  // "generateValues"
        QT_MOC_LITERAL(45, 8)   // "getValue"
    },
    "sensor",
    "valueChanged",
    "",
...
void sensor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->generateValues(); break;
        ...
        {
            using _t = void (sensor::*)(int );
            if (_t _q_method = &sensor::valueChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void sensor::valueChanged(int _t1)
{
