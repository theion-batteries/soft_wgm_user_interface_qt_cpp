...
Section "Uninstall"
  ...
  Delete "$INSTDIR\bin\Debug\cnt_system_exe.exe"
  ...
  Delete "$INSTDIR\bin\Debug\ph_cooling_exe.exe"
  ...
  Delete "$INSTDIR\bin\Debug\wgm_core_exe.exe"
  Delete "$INSTDIR\bin\Debug\whs_exe.exe"
