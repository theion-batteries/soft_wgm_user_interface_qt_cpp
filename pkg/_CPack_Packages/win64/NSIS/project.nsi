...
Section "Uninstall"
  ...
  Delete "$INSTDIR\include\ph_cooling_static"
  Delete "$INSTDIR\include\ph_cooling_static\Iph_axis_motion.h"
  Delete "$INSTDIR\include\ph_cooling_static\ph_cooling_controller.h"
  Delete "$INSTDIR\include\ph_cooling_static\ph_linear_motion.h"
  Delete "$INSTDIR\include\ph_cooling_static\ph_rotation_motion.h"
  Delete "$INSTDIR\include\ph_cooling_static\subsystem_feedback.h"
  Delete "$INSTDIR\include\ph_interface_lib"
  Delete "$INSTDIR\include\ph_interface_lib\Bitmaps.h"
  Delete "$INSTDIR\include\ph_interface_lib\hardware_feedback.h"
  Delete "$INSTDIR\include\ph_interface_lib\Meteor.h"
  Delete "$INSTDIR\include\ph_interface_lib\meteorAdapter.h"
  Delete "$INSTDIR\include\ph_interface_lib\MeteorPath.h"
  Delete "$INSTDIR\include\ph_interface_lib\PrinterInterface.h"
  Delete "$INSTDIR\include\ph_interface_lib\SamplePrint.h"
  Delete "$INSTDIR\include\ph_interface_lib\stdafx.h"
  Delete "$INSTDIR\include\ph_interface_lib\typedef.h"
  ...
  Delete "$INSTDIR\lib\ph_cooling_static.lib"
  Delete "$INSTDIR\lib\ph_interface_lib.lib"
  ...
  RMDir "$INSTDIR\include\ph_cooling_static"
  RMDir "$INSTDIR\include\ph_interface_lib"
