...
Section "Uninstall"
  ...
  Delete "$INSTDIR\bin\Debug\MeteorCLS.dll"
  ...
  Delete "$INSTDIR\bin\Debug\PrintEngine.dll"
  Delete "$INSTDIR\bin\Debug\PrinterInterface.dll"
  Delete "$INSTDIR\bin\Debug\PrinterInterfaceCLS.dll"
  ...
  Delete "$INSTDIR\bin\Debug\wgmApp.exe"
  Delete "$INSTDIR\bin\Debug\yaml-cppd.dll"
  Delete "$INSTDIR\config"
  Delete "$INSTDIR\config\cnt_config.yaml"
  Delete "$INSTDIR\config\heat_config.yaml"
  Delete "$INSTDIR\config\ph_config.yaml"
  Delete "$INSTDIR\config\whs_config.yaml"
  Delete "$INSTDIR\include"
  Delete "$INSTDIR\include\cntLib"
  Delete "$INSTDIR\include\cntLib\cnt_controller.h"
  Delete "$INSTDIR\include\cntLib\cnt_dispenser_vibration.h"
  Delete "$INSTDIR\include\cntLib\cnt_hvac_gbs.h"
  Delete "$INSTDIR\include\cntLib\cnt_linear_motion.h"
  Delete "$INSTDIR\include\cntLib\hardware_feedback.h"
  Delete "$INSTDIR\include\cntLib\Icnt_axis_motion.h"
  Delete "$INSTDIR\include\cntLib\Icnt_dispenser.h"
  Delete "$INSTDIR\include\cntLib\Icnt_high_voltage.h"
  Delete "$INSTDIR\include\cntLib\subsystem_feedback.h"
  Delete "$INSTDIR\include\coolingLib"
  Delete "$INSTDIR\include\coolingLib\Iph_axis_motion.h"
  Delete "$INSTDIR\include\coolingLib\Iph_rotation.h"
  Delete "$INSTDIR\include\coolingLib\Iph_xy_motion.h"
  Delete "$INSTDIR\include\coolingLib\ph_cooling_controller.h"
  Delete "$INSTDIR\include\coolingLib\ph_linear_motion.h"
  Delete "$INSTDIR\include\coolingLib\ph_rotation_motion.h"
  Delete "$INSTDIR\include\coolingLib\ph_trigger.h"
  Delete "$INSTDIR\include\coolingLib\ph_xy_motion.h"
  Delete "$INSTDIR\include\coolingLib\subsystem_feedback.h"
  ...
  Delete "$INSTDIR\include\keyenceLib"
  Delete "$INSTDIR\include\keyenceLib\cntAlignController.h"
  Delete "$INSTDIR\include\keyenceLib\controller.h"
  Delete "$INSTDIR\include\keyenceLib\coolingController.h"
  Delete "$INSTDIR\include\keyenceLib\DlgGetTab1.h"
  Delete "$INSTDIR\include\keyenceLib\DlgGetTab2.h"
  Delete "$INSTDIR\include\keyenceLib\DlgMeasureCtlTab.h"
  Delete "$INSTDIR\include\keyenceLib\DlgModeTab.h"
  Delete "$INSTDIR\include\keyenceLib\DlgOtherTab.h"
  Delete "$INSTDIR\include\keyenceLib\DlgSetTab1.h"
  Delete "$INSTDIR\include\keyenceLib\DlgSetTab2.h"
  Delete "$INSTDIR\include\keyenceLib\extractingController.h"
  Delete "$INSTDIR\include\keyenceLib\hardware_feedback.h"
  Delete "$INSTDIR\include\keyenceLib\heatingController.h"
  Delete "$INSTDIR\include\keyenceLib\keyence_client.h"
  Delete "$INSTDIR\include\keyenceLib\LKIF2.h"
  Delete "$INSTDIR\include\keyenceLib\LkIF2TestVC.h"
  Delete "$INSTDIR\include\keyenceLib\LkIF2TestVCDlg.h"
  Delete "$INSTDIR\include\keyenceLib\LKIF2Tools.h"
  Delete "$INSTDIR\include\keyenceLib\mainController.h"
  Delete "$INSTDIR\include\keyenceLib\Resource.h"
  Delete "$INSTDIR\include\keyenceLib\sinkingController.h"
  Delete "$INSTDIR\include\keyenceLib\stdafx.h"
  ...
  Delete "$INSTDIR\include\wgmApp"
  Delete "$INSTDIR\include\wgmApp\cntAlignView.h"
  Delete "$INSTDIR\include\wgmApp\coolingView.h"
  Delete "$INSTDIR\include\wgmApp\extractingView.h"
  Delete "$INSTDIR\include\wgmApp\heatingView.h"
  Delete "$INSTDIR\include\wgmApp\mainView.h"
  Delete "$INSTDIR\include\wgmApp\mainwindow.h"
  Delete "$INSTDIR\include\wgmApp\menuDebugView.h"
  Delete "$INSTDIR\include\wgmApp\menuEditView.h"
  Delete "$INSTDIR\include\wgmApp\menuFileView.h"
  Delete "$INSTDIR\include\wgmApp\menuHelpView.h"
  Delete "$INSTDIR\include\wgmApp\menuToolsView.h"
  Delete "$INSTDIR\include\wgmApp\menuView.h"
  Delete "$INSTDIR\include\wgmApp\processTabView.h"
  Delete "$INSTDIR\include\wgmApp\sinkingView.h"
  Delete "$INSTDIR\include\wgmApp\view.h"
  Delete "$INSTDIR\include\wgmCoreLib"
  Delete "$INSTDIR\include\wgmCoreLib\aligning_process.h"
  Delete "$INSTDIR\include\wgmCoreLib\cnt_alignment_system.h"
  Delete "$INSTDIR\include\wgmCoreLib\cooling_process.h"
  Delete "$INSTDIR\include\wgmCoreLib\extracting_process.h"
  Delete "$INSTDIR\include\wgmCoreLib\heating_process.h"
  Delete "$INSTDIR\include\wgmCoreLib\heating_system.h"
  Delete "$INSTDIR\include\wgmCoreLib\Iprocess_manager.h"
  Delete "$INSTDIR\include\wgmCoreLib\process_feedback.h"
  Delete "$INSTDIR\include\wgmCoreLib\process_manager.h"
  Delete "$INSTDIR\include\wgmCoreLib\redirect_io.h"
  Delete "$INSTDIR\include\wgmCoreLib\sinking_process.h"
  Delete "$INSTDIR\include\wgmCoreLib\system_feedback.h"
  Delete "$INSTDIR\include\wgmCoreLib\wafer_cooling_system.h"
  Delete "$INSTDIR\include\wgmCoreLib\wafer_holder_motion_system.h"
  Delete "$INSTDIR\include\wgmCoreLib\wgm_communication.h"
  Delete "$INSTDIR\include\wgmCoreLib\wgm_experiment.h"
  Delete "$INSTDIR\include\wgmCoreLib\wgm_monitoring.h"
  Delete "$INSTDIR\include\wgmCoreLib\wgm_test.h"
  Delete "$INSTDIR\include\wgmCoreLib\wgm_user.h"
  Delete "$INSTDIR\include\whsLib"
  Delete "$INSTDIR\include\whsLib\cmdParser.h"
  Delete "$INSTDIR\include\whsLib\Iaxis_motion.h"
  Delete "$INSTDIR\include\whsLib\Idistance_sensor.h"
  Delete "$INSTDIR\include\whsLib\keyence_sensor.h"
  Delete "$INSTDIR\include\whsLib\linear_motion.h"
  Delete "$INSTDIR\include\whsLib\subsystem_feedback.h"
  Delete "$INSTDIR\include\whsLib\whs_controller.h"
  Delete "$INSTDIR\lib"
  ...
  Delete "$INSTDIR\lib\cntLib.lib"
  Delete "$INSTDIR\lib\coolingLib.lib"
  Delete "$INSTDIR\lib\databaseLib.lib"
  ...
  Delete "$INSTDIR\lib\heatingSystemLib.lib"
  Delete "$INSTDIR\lib\keyenceLib.lib"
  Delete "$INSTDIR\lib\modelLib.lib"
  ...
  Delete "$INSTDIR\lib\sqlite3Lib.lib"
  Delete "$INSTDIR\lib\wgmCoreLib.lib"
  Delete "$INSTDIR\lib\whsLib.lib"
  Delete "$INSTDIR\utils"
  Delete "$INSTDIR\utils\camStream.exe"
  ...
  RMDir "$INSTDIR\include\cntLib"
  RMDir "$INSTDIR\include\coolingLib"
  ...
  RMDir "$INSTDIR\include\keyenceLib"
  RMDir "$INSTDIR\include\model"
  RMDir "$INSTDIR\include\sqlite3"
  RMDir "$INSTDIR\include\wgmApp"
  RMDir "$INSTDIR\include\wgmCoreLib"
  RMDir "$INSTDIR\include\whsLib"
