...
public:
    ...
    wgm_feedbacks::enum_sub_sys_feedback ph_motion_move_offset(const double new_pos);
    wgm_feedbacks::enum_sub_sys_feedback ph_motion_home_all();
    wgm_feedbacks::enum_sub_sys_feedback ph_motion_rotate_home();
    wgm_feedbacks::enum_sub_sys_feedback ph_rotate_to_center(const double degree);
    wgm_feedbacks::enum_sub_sys_feedback ph_motion_move_to_center(const double new_pos);
    wgm_feedbacks::enum_sub_sys_feedback ph_rotate_center();
    wgm_feedbacks::enum_sub_sys_feedback ph_rotate_to(const double degree);
